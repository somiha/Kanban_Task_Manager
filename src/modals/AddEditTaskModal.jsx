...
function AddEditTaskModal({
  ...
  const initialStatus = columns.length > 0 ? columns[prevColIndex].name : "";
      ...
      >
        ...
        <div className="mt-8 flex flex-col space-y-1">
          ...
          <textarea
            ...
            className=" bg-transparent outline-none min-h-[200px] focus:border-0 px-4 py-2 rounded-md text-sm  border-[0.5px] border-gray-600 focus:outline-[#635fc7] outline-[1px] ring-0"
